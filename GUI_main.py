...
class Ui_MainWindow(QWidget):
    def __init__(self, parent=None):
        ...
        self.setWindowIcon(QIcon(os.getcwd() + '/model_data/creama.jpg'))
        # self.resize(300, 150)  # 宽×高
        window_pale = QtGui.QPalette()
        window_pale.setBrush(self.backgroundRole(), QtGui.QBrush(
            QtGui.QPixmap(os.getcwd() + '/model_data/background.jpg')))
    ...
    def show_camera(self):  # 摄像头左边
        ...
        dir_path = os.getcwd()
        camera_source = dir_path + "/model_data/stop.jpg"
    ...
    def show_camera1(self):
        ...
        im0 = np.array(self.yolo.detect_image(frame))
    ...
    def show_camera2(self):  # 显示视频的左边
        ...
        if flag == True:
            if self.frame_s % 1 == 0:  # 抽帧
                ...
                camera_source = dir_path + "/model_data/video.jpg"
    ...
    def show_camera3(self):
        ...
        if flag == True:
            if self.frame_s % 1 == 0:  # 抽帧
                ...
                dir_path = os.getcwd()
                frame = cv2.cvtColor(self.image1, cv2.COLOR_BGR2RGB)
                camera_source = dir_path + "/model_data/video.jpg"
...
class picture(QWidget):
    ...
    def __init__(self):
        ...
        self.setWindowIcon(QIcon(os.getcwd() + '/model_data/creama.jpg'))
        self.setWindowTitle("yolov7目标检测平台")
        ...
        camera_or_video_save_path = '/img_out'
    ...
    def button1_test(self):
        ...
        if self.imgname1 != '0':
            ...
            im0 = np.array(self.yolo.detect_image(image))
            ...
            if width / height >= width_new / height_new:
                ...
                show = cv2.resize(im0, (int(width * height_new / height), height_new))
            #im0 = cv2.cvtColor(show, cv2.COLOR_RGB2RGB)
            im0 = show
...
if __name__ == '__main__':
    ...
    splash = QSplashScreen(QPixmap("/model_data/logo.jpg"))
    # 设置画面中的文字的字体
